...
<meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>PT. BAKRIE SUMATRA PLANTIONS</title>
...
<div class="mainwrapper fullwrapper">
    ...
    <div class="leftpanel">
        ...
        <div class="logopanel">
        	<h1><a href="dashboard.php">PT. BAKRIE SUMATRA PLANTIONS TBK</a></h1>
        </div><!--logopanel-->
    ...
    <div class="rightpanel">
		...
		<div class="pagetitle">
        	<h1>SISFO PENGELOLAHAN DATA MATERIAL DERES PADA SEI BALEH ESTATE PT. BAKRIE PLANTIONS TBK</h1> <!--<span>This is a sample description for dashboard page...</span>-->
        </div><!--pagetitle-->
