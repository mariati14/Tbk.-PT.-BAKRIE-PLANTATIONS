...
{
	$q=mysql_query("Insert into data_perencanaan (`tgl`, `kode_barang`, `rata`, `periode`, `lead`, `safety`, `tersedia`, `order`, `eoi`) values ('".date("Y-m-d")."','".$_GET['id']."','".$_POST['a']."','".$_POST['b']."','".$_POST['c']."','".$_POST['d']."','".$_POST['e']."','".$_POST['f']."','".$_POST['g']."')");
	if($q)
	{
